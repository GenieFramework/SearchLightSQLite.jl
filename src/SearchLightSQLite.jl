...
# function SearchLight.Migration.remove_column(table_name::Union{String,Symbol}, name::Union{String,Symbol}) :: Nothing
#   throw(SearchLight.UnsupportedException(:remove_column, Symbol(SQLite)))
# end
